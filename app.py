...
def detect_deforestation():
    ...
    # Apply binary threshold to highlight significant changes
    ...
    # **Convert the percentage to be in the range of 0 - 100**
    deforestation_rate = (changed_pixels / total_pixels) * 100
    deforestation_rate = round(min(deforestation_rate, 100), 2)  # Ensure it stays within 0-100%

    # Convert difference image to base64 for display
